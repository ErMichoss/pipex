...
/*   Updated: 2024/03/15 20:21:33 by nicgonza         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char *argv[], char *envp[])
{
	...
	if (argc < check_heredoc(argv[1], &pipex))
		ft_error_msg("The number of arguments introduced is incorrect");
	...
	if (!pipex.pipe_fd)
		ft_error_msg("Error al reservar memoria para los pipes");
